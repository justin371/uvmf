...
//----------------------------------------------------------------------
class qvip_agent_adapter #(
    bit    USE_EXTERNAL_AGENT=0,
  ...
  `uvm_component_param_utils(
      qvip_agent_adapter#(USE_EXTERNAL_AGENT, EXTERNAL_AGENT_NAME, AGENT_TYPE, TRANSLATOR_TYPE, TRANSACTION_TYPE));
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    if (USE_EXTERNAL_AGENT)
      if (!uvm_config_db#(AGENT_TYPE)::get(null, "*", EXTERNAL_AGENT_NAME, qvip_agent))
        `uvm_error("CFG", {
                   "uvm_config_db #(AGENT_TYPE)::get cannot find resource", EXTERNAL_AGENT_NAME})
      else
        `uvm_info("CFG", {"uvm_config_db #(AGENT_TYPE)::get found resource", EXTERNAL_AGENT_NAME},
                  UVM_MEDIUM)
    else qvip_agent = AGENT_TYPE::type_id::create("qvip_agent", this);
