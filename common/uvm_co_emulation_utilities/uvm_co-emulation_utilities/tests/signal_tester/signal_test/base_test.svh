...
class base_test extends uvm_test;
  ...
  function void build_phase(uvm_phase phase);
    ...
    for (int ii = 0; ii < shared_params_pkg::NUM_CLK_RSTS; ii++) begin
      clk_ctrl[ii] = clock_ctrl #(shared_params_pkg::CLK_INIT_HALF_PERIOD_IN_PS, shared_params_pkg::CLK_PHASE_OFFSET_IN_PS)::type_id::create(
          $sformatf("clk_ctrl%0d", ii));
      //Set the bfm handle in the clk_ctrl
      if (!uvm_config_db#(virtual clock_bfm #(shared_params_pkg::CLK_INIT_HALF_PERIOD_IN_PS, shared_params_pkg::CLK_PHASE_OFFSET_IN_PS))::get(
              this, "", $sformatf("clk%0d_if_h", ii), clk_bfm
          )) begin
      ...
      reset_ctrl[ii] = sync_reset_ctrl#(shared_params_pkg::RST_POLARITY)::type_id::create(
          $sformatf("reset_ctrl%0d", ii));
      //Set the bfm handle in the reset_ctrl
      if (!uvm_config_db#(virtual sync_reset_bfm #(shared_params_pkg::RST_POLARITY))::get(
              this, "", $sformatf("rst%0d_if_h", ii), sync_rst_bfm
          )) begin
    ...
    if (!uvm_config_db#(virtual async_reset_bfm #(shared_params_pkg::ASYNC_RST_POLARITY,
                   shared_params_pkg::ASYNC_INIT_IDLE_TIME_IN_PS,
                   shared_params_pkg::ASYNC_RST_ACTIVE_IN_PS))::get(
            this, "", "async_rst0_if_h", async_rst_bfm0
        )) begin
    ...
    async_reset_ctrl1 = async_reset_ctrl #(shared_params_pkg::ASYNC_RST_POLARITY,
                   shared_params_pkg::ASYNC_INIT_IDLE_TIME_IN_PS*2,
                   shared_params_pkg::ASYNC_RST_ACTIVE_IN_PS*2)::type_id::create(
        "async_reset_ctrl1");
    //Set the bfm handle in the reset_ctrl
    if (!uvm_config_db#(virtual async_reset_bfm #(shared_params_pkg::ASYNC_RST_POLARITY,
                   shared_params_pkg::ASYNC_INIT_IDLE_TIME_IN_PS*2,
                   shared_params_pkg::ASYNC_RST_ACTIVE_IN_PS*2))::get(
            this, "", "async_rst1_if_h", async_rst_bfm1
        )) begin
    ...
    async_reset_ctrl2 = async_reset_ctrl #(shared_params_pkg::ASYNC_RST_POLARITY,
                   shared_params_pkg::ASYNC_INIT_IDLE_TIME_IN_PS*3,
                   shared_params_pkg::ASYNC_RST_ACTIVE_IN_PS*3)::type_id::create(
        "async_reset_ctrl2");
    //Set the bfm handle in the reset_ctrl
    if (!uvm_config_db#(virtual async_reset_bfm #(shared_params_pkg::ASYNC_RST_POLARITY,
                   shared_params_pkg::ASYNC_INIT_IDLE_TIME_IN_PS*3,
                   shared_params_pkg::ASYNC_RST_ACTIVE_IN_PS*3))::get(
            this, "", "async_rst2_if_h", async_rst_bfm2
        )) begin
    ...
    clk0_monitor_proxy = signal_monitor_proxy #(shared_params_pkg::CLK_COUNTER_SIZE,
                                   shared_params_pkg::CLK_MONITOR_BUF_SIZE)::type_id::create(
        "clk0_monitor_proxy");
    if (!uvm_config_db#(virtual signal_monitor_bfm #(shared_params_pkg::CLK_COUNTER_SIZE,
                                  shared_params_pkg::CLK_MONITOR_BUF_SIZE))::get(
            this, "", "clk0_count_monitor", clk0_monitor_bfm
        )) begin
    ...
    cpu_r1_driver_proxy = signal_driver_proxy #(shared_params_pkg::SIGNAL_DRIVER_SIZE)::type_id::create(
        "cpu_r1_driver_proxy");
    if (!uvm_config_db#(virtual signal_driver_bfm #(shared_params_pkg::SIGNAL_DRIVER_SIZE))::get(
            this, "", "cpu_r1_driver", cpu_r1_driver_bfm
        )) begin
    ...
    cpu_pc_monitor =
        cpu_pc_monitor_proxy#(`CPU_PC_NUMBER_OF_TRIGGERS)::type_id::create("cpu_pc_monitor");
    if (!uvm_config_db#(virtual cpu_pc_monitor_bfm #(`CPU_PC_NUMBER_OF_TRIGGERS))::get(
            this, "", "cpu_pc_monitor", cpu_pc_monitor_bfm
        )) begin
