...
module apb_monitor_hvl_wrapper #(
    SLAVE_COUNT   = 1,
    ADDR_WIDTH    = 32,
    WDATA_WIDTH   = 32,
    RDATA_WIDTH   = 32,
...
`ifdef USE_VTL
  ...
  typedef virtual mgc_apb3 #(SLAVE_COUNT, ADDR_WIDTH, WDATA_WIDTH, RDATA_WIDTH) apb3_if_t;

  mgc_apb3 #(SLAVE_COUNT, ADDR_WIDTH, WDATA_WIDTH, RDATA_WIDTH) apb3_monitor_if (
      clk,
      rst_n
  );
