...
class uvmf_parameterized_agent #(
  ...
  `uvm_component_param_utils(
      uvmf_parameterized_agent#(CONFIG_T, DRIVER_T, MONITOR_T, COVERAGE_T, TRANS_T, SEQUENCER_T))
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    if (monitor == null) begin : monitor_null_check
      if (!uvm_config_db#(MONITOR_T)::get(
              this, "", UVMF_MONITORS, monitor
          )) begin : monitor_config_db_check
    ...
    if (configuration.active_passive == ACTIVE) begin : is_active
      ...
      uvm_config_db#(SEQUENCER_T)::set(null, UVMF_SEQUENCERS, configuration.interface_name,
                                       sequencer);
      // Driver
