...
class uvmf_parameterized_simplex_environment #(
  ...
  `uvm_component_param_utils(
      uvmf_parameterized_simplex_environment#(CONFIG_T, INPUT_AGENT_T, OUTPUT_AGENT_T, PREDICTOR_T, SCOREBOARD_T, USE_GPIO_AGENT, GPIO_AGENT_T))
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    if (USE_GPIO_AGENT) gpio_agent = GPIO_AGENT_T::type_id::create("gpio_agent", this);
